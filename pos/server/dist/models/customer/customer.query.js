...
const getCustomerById = (id) => __awaiter(void 0, void 0, void 0, function* () {
    const customer = yield customer_model_1.default.aggregate([
        {
            $match: {
                customerId: id
            },
...
const createCustomer = (customerObject) => __awaiter(void 0, void 0, void 0, function* () {
    const customer = yield customer_model_1.default.create(Object.assign({}, customerObject));
    return customer;
});
